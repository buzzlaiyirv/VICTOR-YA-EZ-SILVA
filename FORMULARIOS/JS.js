...
Acepta programacion funcional, estructurada, POO, eventos. Dentro de JS no existe int, double, float, string, etc
...
function validar(formulario){
    ...
    //vamos hacer un bucle mediante el cual primero obtenga la cadena del nombre y la separe en caracteres,
    //una vez que tenga cada caracter debo de comparalo con la cadena que en este momento estoy considerando 
    //como la verdad absoluta, y si despues de recorrer toda la cadena encuentro que el caracter no se encuentra, 
    //envie un error.
